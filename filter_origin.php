...
<html lang="en">
  <head>
    ...
    <?php $get_origin = $_GET['origin'];?>
    <title><?php echo $get_origin?> | HDMovies.com</title>
    <style>
        .smart-scroll{
        position: fixed;
        top: 0;
  ...
  <body>
    ...
    <div class="container my-3">
        <div class="row">
            <?php
            $get_origin_query = "SELECT * FROM movie WHERE video_origin='$get_origin'";
            $sql_result  = mysqli_query($connection, $get_origin_query);
            if(!$sql_result->num_rows > 0)
            {
            ?>
                <h1 class="text-warning">No <?php echo $get_origin?> Movies/WebSeries Found </h1>
            <?php
            }
